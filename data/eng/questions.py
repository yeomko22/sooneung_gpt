...
question_2 = """
Q. 대화를 듣고, 남자의 의견으로 가장 적절한 것을 고르시오.
...
W: During our student council meeting, she was taking too long to make her
point, so I had to jump in to finish her sentence.
M: Oh, no. You shouldn’t interrupt someone when they’re in the middle of
speaking.
...
question_3 = """
Q. 다음을 듣고, 여자가 하는 말의 요지로 가장 적절한 것을 고르시오.

W: Hello, listeners. This is Dr. Graham’s One-minute Health Tips. Getting a
good night’s sleep is important for your health. But recently, more and more
people are experiencing trouble falling asleep. If that’s your case, wearing
an eye mask for sleeping can help you fall asleep. If your room doesn’t get
dark enough, it’ll be difficult to fall asleep. This is because light interferes
with the release of the hormone that makes you sleepy. An eye mask can
block the light, which makes it easier for you to fall asleep. Why not try one
tonight? I’ll be back with more tips next time!
...
question_4 = """
Q. 대화를 듣고, 그림에서 대화의 내용과 일치하지 않는 것을 고르시오.

[Picture Description] 
① The image appears to be an advertisement for a "CAMPING GEAR SALE up to 50%". The sale event is highlighted at the top of the image (1). Items included in the sale seem to be:
② A traditional cone-shaped tent, with the entrance slightly open, indicating ease of setup and use.
③ A sturdy backpack, likely designed for hiking, placed on top of a cooler box, suggesting that it may be part of the gear on sale. The cooler box, which seems robust and suitable for keeping food and beverages cold while camping.
④ A folding camping table set with chairs
⑤ a teapot, and some cups, arranged on a striped tablecloth.
...
question_5 = """
Q. 대화를 듣고, 여자가 할 일로 가장 적절한 것을 고르시오.
...
question_7 = """
Q. 대화를 듣고, 여자가 산책을 할 수 없는 이유를 고르시오.

W: It was nice having lunch outside the office.
M: Yes. It feels so good now that fall is in the air. Shall we take a walk as usual
...
M: So, why not today?
W: Actually, I need to visit the police station. I got a text message saying that
my new driver’s license is ready.
...
question_8 = """
Q. 대화를 듣고, 남자가 예약할 연극 공연에 관해 언급되지 않은 것을 고르시오.
...
question_9 = """
Q. Golden Palette Walking Tour에 관한 다음 내용을 듣고, 일치하지 않는 것을 고르시오.
...
question_10 = """
Q. 다음 표를 보면서 대화를 듣고, 남자가 주문할 접이식 카트를 고르시오.
| Model | Price | Weight Limit | Color | Handle Material |
| --- | --- | --- | --- | --- |
| A | $38 | 30kg | Black | Silicone |
| B | $42 | 40kg | Green | Silicone |
| C | $44 | 45kg | Blue | Metal |
| D | $48 | 50kg | White | Metal |
| E | $53 | 45kg | Red | Rubber |

W: Honey, what are you doing on your laptop?
M: I’m trying to choose one of these foldable carts. You know our cart broke
yesterday.
...
M: Good idea. Now, there are two options left. Which handle material do you
like better?
...
question_11 = """
Q. 대화를 듣고, 여자의 마지막 말에 대한 남자의 응답으로 가장 적절한 것을 고르시오.
...
question_12 = """
Q. 대화를 듣고, 남자의 마지막 말에 대한 여자의 응답으로 가장 적절한 것을 고르시오.
...
"""
question_15 = """
다음 상황 설명을 듣고, Jake가 Yuna에게 할 말로 가장 적절한 것을 고르시오.
...
question_19 = """
Q. 다음 글에 드러난 David의 심경 변화로 가장 적절한 것은
...
question_21 = """
Q. 밑줄 친 a nonstick frying pan이 다음 글에서 의미하는 바로 가장 적절한 것은?
...
question_25 = """
Q. 다음 도표의 내용과 일치하지 않는 것은?

Percentages of Respondents Who Sometimes or Often
Actively Avoided News in Five Countries in 2017, 2019, and 2022
...
question_27 = """
Q. Turtle Island Boat Tour에 관한 다음 안내문의 내용과 일치하지 않는 것은?
...
"""
question_28 = """
Q. 2023 Eastland High School Video Clip Contest에 관한 다음 안내문의 내용과 일치하는 것은?
...
question_30 = """
Q. 다음 글의 밑줄 친 부분 중, 문맥상 낱말의 쓰임이 적절하지 않은 것은?
...
is not simply ____________________. Even in the easiest
...
space and time, it in fact _______________________.
...
_____________________________________. That’s
...
question_40 = """
Q. 다음 글의 내용을 한 문장으로 요약하고자 한다. 빈칸 (A), (B)에 들어갈 말로 가장 적절한 것은?
...
Exploring one scientific subject after another (A)
remarkable work across the sciences, as the previously
gained knowledge is retained in simplified forms within
the brain, which (B) room for new learning.
...
question_42 = """
Q. 밑줄 친 (a)～(e) 중에서 문맥상 낱말의 쓰임이 적절하지 않은 것은?
...
question_43 = """
Q. 주어진 글 (A)에 이어질 내용을 순서에 맞게 배열한 것으로 가장 적절한 것은?
...
question_44 = """
Q. 밑줄 친 (a)～(e) 중에서 가리키는 대상이 나머지 넷과 다른 것은? 
